...
MINUTE = 1 / 60  # one minute in units of hours
...
class GCPCustomN1Cost:
    ...
    @classmethod
    def estimate(cls, cpus: int, memory_gb: int, runtime_hours: float, preemptible: bool) -> float:
        ...
        cost_duration_hours = MINUTE if MINUTE >= runtime_hours else runtime_hours
