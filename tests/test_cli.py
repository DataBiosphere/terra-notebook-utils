...
class TestCLI_Config(SuppressWarningsMixin, unittest.TestCase):
...
class TestCLI_VCF(SuppressWarningsMixin, CLITestMixin, unittest.TestCase):
...
@testmode("workspace_access")
class TestCLI_Workspace(CLITestMixin, unittest.TestCase):
    def test_list(self):
...
@testmode("workspace_access")
class TestCLI_Profile(CLITestMixin, unittest.TestCase):
...
class TestCLI_DRSInDev(CLITestMixin, unittest.TestCase):
...
@testmode("controlled_access")
class TestCLI_DRS(CLITestMixin, unittest.TestCase):
...
@testmode("workspace_access")
class TestCLI_Table(CLITestMixin, unittest.TestCase):
    common_kwargs = dict(workspace=WORKSPACE_NAME, workspace_namespace=WORKSPACE_GOOGLE_PROJECT)
